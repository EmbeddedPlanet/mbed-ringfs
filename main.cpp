...
const uint16_t FLASH_SECTOR_SIZE   =    1024;
const uint8_t FLASH_TOTAL_SECTORS   =  16;
const uint8_t FLASH_PARTITION_OFFSET = 8;
const uint8_t FLASH_PARTITION_SIZE   = 4;
...
int main()
{
    ...
    const struct log_entry log1 { 1, "foo" };
    ringfs_append(&fs, &log1);
