...
struct ringfs_flash_partition
{
    ...
    mbed::Callback<int(struct ringfs_flash_partition*,
   		 int)> sector_erase;
    ...
    mbed::Callback<ssize_t(struct ringfs_flash_partition*,
   		 int, const void*, size_t)> program;
...
typedef struct ringfs_flash_partition ringfs_flash_partition_t;
